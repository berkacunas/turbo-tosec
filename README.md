...
* **Windows:** [Download `turbo-tosec_v1.3.5_Windows.exe`](https://github.com/berkacunas/turbo-tosec/releases/latest)
* **Linux:** [Download `turbo-tosec_v1.3.5_Linux.tar.gz`](https://github.com/berkacunas/turbo-tosec/releases/latest)
